...
describe Dessert do
  ...
  describe '#mix!' do
    it 'shuffles the ingredient array' do
      ...
      expect(cookie.ingredients).to eq(%w[sugar eggs flour])
      cookie.mix!
      expect(cookie.ingredients).not_to equal(%w[sugar eggs flour])
      expect(cookie.ingredients.sort).not_to equal(%w[sugar eggs flour].sort)
    end
  end
